...
SECRET_KEY = 'django-insecure-$b)oo-@zz&47tcymia-)k@7f%!tgf=z!b^ok%#sfmj3z225nf0'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        # 'rest_framework_simplejwt.authentication.JWTAuthentication',  # Token-based authentication (optional)
    ],
